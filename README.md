...
以前データベーススペシャリスト試験の取得を目標にデータベースの基礎知識を学習していましたが、その際は知識を体系的に学習することに苦労していました。

データベースの基礎知識を体系的に学習するためには、カテゴリーごとに複数の参考書やネット上から情報を収集し、それらを自分なりに整理する必要がありました。

そのため、以前学習した内容を元に、データベースの基礎知識を体系的に学習できる Web サイトを作成してみたいと考え、当サイトを作成しました。
